...
<head>
    ...
    <title>Dashboard NTPD 112 Dottoro'ta Home Care</title>
</head>
...
<body class="chat-body">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="pesan"  aria-expanded="false" data-target="#submenu-5" aria-controls="submenu-5"><i class="fas fa-envelope"></i>Pesan</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="admin"  aria-expanded="false" data-target="#submenu-5" aria-controls="submenu-5"><i class="fas fa-users"></i>Admin</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="chat-module-top">
                            ...
                            <div class="chat-module-body">
                                <div class="media chat-item">
                                    <img alt="William" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-1.jpg" class="rounded-circle user-avatar-lg">
                                ...
                                <div class="media chat-item">
                                    <img alt="Komal" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-2.jpg" class="rounded-circle user-avatar-lg">
                                    <div class="media-body">
                                        <div class="chat-item-title">
                                ...
                                <div class="media chat-item">
                                    <img alt="tanu" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-3.jpg" class="rounded-circle user-avatar-lg">
                                    <div class="media-body">
                                        <div class="chat-item-title">
                                ...
                                <div class="media chat-item">
                                    <img alt="Bhoomi" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-4.jpg" class="rounded-circle user-avatar-lg">
                                    <div class="media-body">
                                        <div class="chat-item-title">
                                ...
                                <div class="media chat-item">
                                    <img alt="Daniel" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-2.jpg" class="rounded-circle user-avatar-lg">
                                    <div class="media-body">
                                        <div class="chat-item-title">
                                ...
                                <div class="media chat-item">
                                    <img alt="Fallon" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-3.jpg" class="rounded-circle user-avatar-lg">
                                    <div class="media-body">
                                        <div class="chat-item-title">
                                ...
                                <div class="media chat-item">
                                    <img alt="Kimberly" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-4.jpg" class="rounded-circle user-avatar-lg">
                                    <div class="media-body">
                                        <div class="chat-item-title">
                            ...
                            <div class="chat-team-sidebar text-small">
                                <div class="chat-team-sidebar-top">
                                    <div class="media align-items-center">
                                        <a href="#" class="mr-2">
                                            <img alt="Team Avatar" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-2.jpg" class="rounded-circle user-avatar-xl">
                                        </a>
                                        <div class="media-body">
                                                ...
                                                <div class="list-group list-group-flush  list">
                                                    <a class="list-group-item list-group-item-action" href="#">
                                                        <div class="media media-member mb-0">
                                                            <img alt="Claire Connors" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-1.jpg" class="avatar">
                                                            <div class="media-body ">
                                                    ...
                                                    <a class="list-group-item list-group-item-action" href="#">
                                                        <div class="media media-member mb-0">
                                                            <img alt="Marcus Simmons" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-2.jpg" class="avatar">
                                                            <div class="media-body">
                                                    ...
                                                    <a class="list-group-item list-group-item-action" href="#">
                                                        <div class="media media-member mb-0">
                                                            <img alt="Peggy Brown" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-3.jpg" class="avatar">
                                                            <div class="media-body">
                                                    ...
                                                    <a class="list-group-item list-group-item-action" href="#">
                                                        <div class="media media-member mb-0">
                                                            <img alt="Harry Xai" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-3.jpg" class="avatar">
                                                            <div class="media-body">
                                                    ...
                                                    <a class="list-group-item list-group-item-action" href="#">
                                                        <div class="media media-member mb-0">
                                                            <img alt="Sally Harper" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-1.jpg" class="avatar">
                                                            <div class="media-body">
                                                    ...
                                                    <a class="list-group-item list-group-item-action" href="#">
                                                        <div class="media media-member mb-0">
                                                            <img alt="Ravi Singh" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-2.jpg" class="avatar">
                                                            <div class="media-body">
                                                    ...
                                                    <a class="list-group-item list-group-item-action" href="#">
                                                        <div class="media media-member mb-0">
                                                            <img alt="David Whittaker" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-3.jpg" class="avatar">
                                                            <div class="media-body">
                                                    ...
                                                    <a class="list-group-item list-group-item-action" href="#">
                                                        <div class="media media-member mb-0">
                                                            <img alt="Kerri-Anne Banks" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-4.jpg"  class="avatar ">
                                                        <div class="media-body ">
                                                    ...
                                                    <a class="list-group-item list-group-item-action " href="# ">
                                                    <div class="media media-member mb-0 ">
                                                        <img alt="Masimba Sibanda " src="../<?php echo base_url()?>assets/admin/assets/images/avatar-3.jpg" class="avatar">
                                                            <div class="media-body">
                                                    ...
                                                    <a class="list-group-item list-group-item-action" href="#">
                                                        <div class="media media-member mb-0">
                                                            <img alt="Krishna Bajaj" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-2.jpg"  class="avatar ">
                                                        <div class="media-body ">
                                                    ...
                                                    <a class="list-group-item list-group-item-action " href="# ">
                                                    <div class="media media-member mb-0 ">
                                                        <img alt="Kenny Tran " src="../<?php echo base_url()?>assets/admin/assets/images/avatar-1.jpg" class="avatar">
                                                            <div class="media-body">
                                                    ...
                                                    <li class="list-group-item dz-preview dz-file-preview">
                                                        <div class="media align-items-center dz-details">
                                                            <ul class="avatars list-unstyled">
                                                                ...
                                                                <li>
                                                                    <img alt="David Whittaker" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-4.jpg" class="avatar" data-title="David Whittaker" data-toggle="tooltip">
                                                                </li>
                                                            </ul>
                                                            <div class="media-body d-flex justify-content-between align-items-center">
                                                                ...
                                                                <img alt="Loader" src="../<?php echo base_url()?>assets/admin/assets/images/loader.svg" class="dz-loading">
                                                                <div class="dropdown">
                                                    ...
                                                    <li class="list-group-item" data-t="null" data-i="null" data-l="null" data-e="null">
                                                        <div class="media align-items-center">
                                                            <ul class="avatars list-unstyled">
                                                                ...
                                                                <li>
                                                                    <img alt="Peggy Brown" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-1.jpg" class="avatar filter-by-data-title" data-title="Peggy Brown" data-toggle="tooltip" data-filter-by="data-title">
                                                                </li>
                                                            </ul>
                                                            <div class="media-body d-flex justify-content-between align-items-center">
                                                                <div>
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="media align-items-center">
                                                            <ul class="avatars list-unstyled">
                                                                ...
                                                                <li>
                                                                    <img alt="Harry Xai" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-2.jpg" class="avatar filter-by-data-title" data-title="Harry Xai" data-toggle="tooltip" data-filter-by="data-title">
                                                                </li>
                                                            </ul>
                                                            <div class="media-body d-flex justify-content-between align-items-center">
                                                                <div>
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="media align-items-center">
                                                            <ul class="avatars list-unstyled">
                                                                ...
                                                                <li>
                                                                    <img alt="Ravi Singh" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-4.jpg" class="avatar filter-by-data-title" data-title="Ravi Singh" data-toggle="tooltip" data-filter-by="data-title">
                                                                </li>
                                                            </ul>
                                                            <div class="media-body d-flex justify-content-between align-items-center">
                                                                <div>
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="media align-items-center">
                                                            <ul class="avatars list-unstyled">
                                                                ...
                                                                <li>
                                                                    <img alt="Claire Connors" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-3.jpg" class="avatar filter-by-data-title" data-title="Claire Connors" data-toggle="tooltip" data-filter-by="data-title">
                                                                </li>
                                                            </ul>
                                                            <div class="media-body d-flex justify-content-between align-items-center">
                                                                <div>
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="media align-items-center">
                                                            <ul class="avatars list-unstyled">
                                                                ...
                                                                <li>
                                                                    <img alt="David Whittaker" src="../<?php echo base_url()?>assets/admin/assets/images/avatar-4.jpg" class="avatar filter-by-data-title" data-title="David Whittaker" data-toggle="tooltip" data-filter-by="data-title">
                                                                </li>
                                                            </ul>
                                                            <div class="media-body d-flex justify-content-between align-items-center">
                                                                <div>
    ...
    <script src="<?php echo base_url()?>assets/admin/assets/vendor/dropzone/dropzone.js"></script>
